              ...
              if (index === nodes.length) {
                if (object) {
                  ...
                  if (success) {
                    ...
                    shortestNodes =
                      board.objectShortestPathNodesToAnimate.concat(
                        board.shortestPathNodesToAnimate
                      );
                    return;
                  } else {
        ...
        Board.prototype.drawShortestPath = function (
          ...
          if (this.currentAlgorithm !== "bidirectional") {
            ...
            if (
              ...
              currentNode =
                this.nodes[this.nodes[this.middleNode].previousNode];
              secondCurrentNode =
              ...
              while (secondCurrentNode.id !== targetNodeId) {
                ...
                secondCurrentNode =
                  this.nodes[secondCurrentNode.otherpreviousNode];
              }
            } else {
              document.getElementById(
        ...
        Board.prototype.toggleButtons = function () {
          ...
          if (!this.buttonsOn) {
            ...
            document.getElementById("startButtonClearBoard").onclick = () => {
              ...
              let navbarHeight =
                document.getElementById("navbarDiv").clientHeight;
              let textHeight =
